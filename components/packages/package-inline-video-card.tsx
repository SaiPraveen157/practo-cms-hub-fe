...
export function PackageInlineVideoCard({
  ...
  const metadataBlock = (
    <div className="flex h-full min-h-0 flex-col space-y-4 rounded-xl border border-border bg-muted/20 p-4 sm:p-5">
      ...
      {metaDescription ? (
        <div className="space-y-1">
          ...
          <div className="max-h-48 overflow-y-auto rounded-lg border border-border/80 bg-background/80 p-3 text-sm leading-relaxed whitespace-pre-wrap text-foreground">
            {metaDescription}
          </div>
        </div>
      ) : null}
  ...
  const thumbsColumnInner =
    nestedThumbs.length > 0 ? (
      ...
      <div className="flex h-full min-h-0 flex-col space-y-4 rounded-xl border border-border bg-muted/20 p-4 sm:p-5">
        ...
        <div className="flex flex-1 items-center justify-center rounded-lg border border-dashed border-border bg-muted/10 p-6 text-sm text-muted-foreground">
