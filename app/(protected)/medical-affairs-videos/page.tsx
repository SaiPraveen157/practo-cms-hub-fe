...
import { filterStaleMedicalReviewVideos } from "@/lib/video-queue-utils"
...
export default function VideosPage() {
  ...
  const canAccess = isMedical || role === "SUPER_ADMIN"
  ...
  const fetchQueue = useCallback(async () => {
    ...
    try {
      ...
      setVideos(filterStaleMedicalReviewVideos(combined))
    } catch (e) {
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground">
              Only Medical Affairs can access this page.
            </p>
            <Button
              variant="outline"
              className="mt-4"
            ...
            {filteredVideos.map((video) => {
              ...
              return (
                <Card
                  ...
                  onClick={() =>
                    router.push(`/medical-affairs-videos/${video.id}`)
                  }
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => {
